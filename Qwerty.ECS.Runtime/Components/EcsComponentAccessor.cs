...
// 		{
// 			get => m_buckets->Get<UnsafeArray>(entity.Index / EcsComponentPool<T>.BucketSize).Read<T>(entity.Index % EcsComponentPool<T>.BucketSize);
// 			set => m_buckets->Get<UnsafeArray>(entity.Index / EcsComponentPool<T>.BucketSize).Write(entity.Index % EcsComponentPool<T>.BucketSize, value);
// 		}
// 	}
// }